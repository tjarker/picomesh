...
interleaved_bus(["io_resp_0_out_data_data", "io_resp_0_in_data_data"], range(32))
...
interleaved_bus(["io_resp_1_out_data_data", "io_resp_1_in_data_data"], range(32))
...
interleaved_bus(["io_resp_2_in_data_data", "io_resp_2_out_data_data"], range(32))
...
interleaved_bus(["io_resp_3_in_data_data", "io_resp_3_out_data_data"], range(32))